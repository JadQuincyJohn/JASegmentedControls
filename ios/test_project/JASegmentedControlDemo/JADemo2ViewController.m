...
@interface JADemo2ViewController()

@property (nonatomic, retain) IBOutlet JAFocusSegmentedControl * segmentedControl;

@end

@implementation JADemo2ViewController
...
- (void)setUpSegmentedControl:(JASegmentedControl*)control {
    ...
    // Fonts
    UIFont * font1 = [UIFont fontWithName:@"Verdana-Bold" size:13];
